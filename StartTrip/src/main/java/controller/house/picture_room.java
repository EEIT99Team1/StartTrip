 ...
 */
@WebServlet("/page/House/picture_room")
public class picture_room extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		upload.setSizeMax( maxFileSize );
			...
			Iterator<FileItem> i = fileItems.iterator();
				...
				FileItem fi = i.next();
					if ( !fi.isFormField() ) {
						...
						count++;
						// Write the file
						file = new File(filePath+bean.getName().trim()+"--"+fileName);
			...
			request.setAttribute("picture", "修改成功");
