...
<body>
	...
	<div class="container">
		...
		<div id="print_alls">
			...
			<table class="table table-sm" style="display: block;">
				<thead>
					<tr>
						<th colspan="2">
							<h4>聯絡人資料確認</h4>
		...
		<!--         </table> -->
		<span id="passengerVeiw" style="display: block;"> <c:if
				test="${not empty abean1}">
			...
			</c:if> <br /> <c:if test="${not empty abean2}">
			...
			</c:if> <br /> <c:if test="${not empty abean3}">
			...
			</c:if> <br /> <c:if test="${not empty abean4}">
			...
			</c:if> <br /> <c:if test="${not empty cbean1}">
			...
			</c:if> <br /> <c:if test="${not empty cbean2}">
			...
			</c:if> <br /> <c:if test="${not empty cbean3}">
			...
			</c:if> <br /> <c:if test="${not empty cbean4}">
	...
	<div class="container"
		style="padding: 0 18% 45px 18%; background: rgba(255, 244, 194, 0);">
		<form action="<c:url value='/ForwordToHouse.controller'/>"
			method="get">
			<a href="#" onclick="printScreen(print_alls);"><input
				class="btn btn-secondary" style="opacity: 0.8" type="button"
				value="列印明細" /></a> <a href="<c:url value='/index.jsp'/>"> <input
				class="btn btn-secondary" style="opacity: 0.8" type="button"
				value="回查詢首頁" /></a> <input class="btn btn-secondary"
				style="opacity: 0.8" type="submit" value="續訂民宿" />
		</form>
	</div>
