		...
		<form class="search" action="FlightGet.controller" method="get">
			<div>
				...
				<div class="searchdiv">
					<h3>日期:</h3>
					<div>
						去程: <input type="text" id="datego" name="gotime" /> 回程: <input
							type="text" id="dateback" name="backtime" />
						<!--                             <a href="02middle.html"><input type="button" value="查詢" /></a> -->
						<input type="submit" value="查詢" />
					</div>
				</div>
				<div class="searchdiv">
					<input type="radio" name="way" id="double" required value="Return"
						checked /><label for="double">來回</label> <input type="radio"
						name="way" id="one" value="OneWay" /><label for="one">單程</label>
